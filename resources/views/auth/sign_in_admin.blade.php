                            ...
                            <div class="flex flex-col bg-white rounded-lg dark:bg-neutral-800">
                                <div class="grid flex-col grid-cols-12 ">
                                    <div class="col-span-12 lg:col-span-6 ltr:rounded-l-lg rtl:rounded-r-lg">
                                        <div class="p-10">
                                            <a href="index.html">
                                                <img src="{{asset('')}}client/images/logo-light.png" alt=""
                                            ...
                                            <form action="{{route('login_admin')}}" method="post" class="mt-8">
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <input name="email" type="email"
                                                        ...
                                                        required="" id="usernameInput" placeholder="Enter your email">
                                                </div>
                                                <div class="mb-5">
                                                ...
                                                <div class="my-8 text-center">
                                                    <button type="submit"
                                                        class="btn w-full bg-white text-gray-900 font-medium border-transparent hover:-translate-y-1.5 duration-500 ease">Login
                                                    </button>
                                                </div>
                                            </form>
                                            <div class="text-center">
