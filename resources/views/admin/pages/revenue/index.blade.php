    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            function chart30daysorder() {
                ...
                $.ajax({
                    url: "{{ route('admin.revenueAdmin.dayrevenue') }}",
                    method: "POST",
                    dataType: "JSON",
                    data: { _token: _token },
    ...
    $('#btn-export-pdf').click(function() {
        ...
        // Gửi yêu cầu xuất PDF với dữ liệu từ form
        $.ajax({
            url: url,
            method: "POST",
            dataType: "JSON",
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form autocomplete="off" class="mb-4 mt-4">
                        @csrf
                        <div class="col-md-3">
                            <p><button type="submit" id="btn-export-pdf" class="btn btn-primary btn-sm form-control" data-url="{{ route('admin.revenueAdmin.admin.revenue.filter_by_select') }}" >Xuất PDF</button></p>
                        </div>
