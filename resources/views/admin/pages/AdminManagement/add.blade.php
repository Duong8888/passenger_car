    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table mb-0">
                <form action="{{ route('route_adminmanagement_add') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <h1 class="ml-5 mb-3">Quản lý người dùng</h1>
                    ...
                    <button class="ml-3 ml-5 btn btn-primary" type="submit">Thêm</button> 
                    <button  class="btn btn-primary ml-5 "><a style="text-decoration: none; color: white;" href="{{route('route_adminmanagement_index')}}">List Users</a></button>
                </form>
            </table>
        </div>
    </div>
