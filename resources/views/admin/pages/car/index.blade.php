                ...
                <div class="card-body">
                    ...
                    <div class="d-flex mb-4 justify-content-between">
                        <button id="modal-btn" type="button" class="btn mb-2 btn-success waves-effect waves-light"
                            data-bs-toggle="modal" data-bs-target="#con-close-modal">Thêm mới xe
                        </button>
                        <form action="{{ route('admin.ticket.search') }}" method="get" class="form-inline">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-auto">
                                    <select name="" id="" class="Passenger">
                    ...
                    <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog"
                        ...
                        <form id="form-main" class="modal-dialog modal-dialog modal-lg modal-dialog-scrollable"
                            method="POST" action="{{route('admin.car.store')}}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="modal-body">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="license_plate" class="form-control"
                                                    id="field-1" placeholder="B52-198">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="price" class="form-control"
                                                    id="example-number" placeholder="350.000">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="capacity">
                                                    ...
                                                    <option id="{{$value->id}}" value="{{$value->type_name}}">
                                                        {{$value->type_name}} chỗ</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 d-flex">
                                            ...
                                            <div class="form-check mb-2 form-check-success">
                                                <input class="form-check-input" checked id="y" value="1" name="type"
                                                    type="radio">
                                                <label class="form-check-label" for="y">Có chọn ghế</label>
                                            </div>
                                            <div class="form-check mb-2 form-check-success px-4">
                                                <input class="form-check-input" id="n" value="0" name="type"
                                                    type="radio">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="mb-3 d-flex flex-wrap">
                                                ...
                                                <div class="form-check mb-2 form-check-success"
                                                    ...
                                                    <input class="form-check-input service" name="service[]"
                                                        type="checkbox" value="{{$value->id}}"
                                                        id="customckeck{{$value->id}}">
                                                    <label class="form-check-label"
                                                        for="customckeck{{$value->id}}">{{$value->service_name}}</label>
                                                </div>
                                                @endforeach
                                            </div>
                                    ...
                                    <div class="show-item">
                                        <div class="row add-item mb-2">
                                            <div class="col-md-5">
                                                <input class="form-control" name="departure[]" id="" type="time"
                                                    name="time" value="01:00">
                                            </div>
                                            <div class="col-md-5">
                                                <input class="form-control" name="arrival[]" id="" type="time"
                                                    name="time" value="05:00">
                                            </div>
                        ...
                        <table class="table table-bordered mb-0">
                            ...
                            <tbody class="tbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                ...
                                                <a class="dropdown-item delete" data-id="{{$value->id}}"
                                                    href="#">Xóa</a>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <p>{{$value->$keyColum->departure}}
                                            - {{$value->$keyColum->arrival}}</p>
                                    </td>
                                    @else
                                    <td>
                                        <p>Chưa hoạt động.</p>
...
@section('page-script')
<script>
    $(document).on('click', '#license_plate', function () {
                let id = $(this).val();
                $.ajax({
                    ...
                    success: function (data) {
                        $('.Passenger').html('<option value="">Chọn</option>');
