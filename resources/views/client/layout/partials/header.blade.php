                                ...
                                <div
                                    ...
                                    <div class="p-12 bg-white dark:bg-neutral-800">
                                        <div class="mb-4 text-center">
                                            ...
                                            <p class="text-gray-500 dark:text-gray-300">Sign Up and get access to all
                                                the features of Jobcy</p>
                                        </div>
                                        <div class="mb-4">
                                        ...
                                        <div class="mb-3 ltr:float-left rtl:float-right">
                                            <a href="#!">
                                                ...
                                                <label class="dark:text-gray-50" for="flexCheckDefault">I agree to the
                                                </label></a><a href="javascript:void(0)"
                                                        ...
                                                        <div>
                                                            <a href="#!">
                                                                <div
                                                                    ...
                                                                    <div class="flex-grow">
                                                                        <h6
                                                                            class="mb-1 text-sm text-gray-700 dark:text-gray-300">
                                                                            22 verified registrations</h6>
                                                                        <div
                                                                            class="text-gray-600 text-13 dark:text-gray-300">
                                                                            <p class="mb-0"><i
            ...
            <div id="navbar-collapse"
                ...
                <ul class="flex flex-col items-start mt-5 mb-10 font-medium lg:mt-0 lg:mb-0 lg:items-center lg:flex-row"
                    ...
                    <li class="relative dropdown">
                        <button class="py-5 text-gray-800 lg:px-4 dropdown-toggle dark:text-gray-50 lg:h-[70px] active"
                            id="home" data-bs-toggle="dropdown">Home <i
                                class="align-middle bx bxs-chevron-down ltr:ml-1 rtl:mr-1"></i></button>

                        <ul class="relative top-auto z-50 w-full py-2 list-none bg-white border-0 rounded dropdown-menu lg:border border-gray-500/20 lg:absolute ltr:-left-3 rtl:-right-3 lg:w-48 lg:shadow-lg dark:bg-neutral-800 hidden"
                    ...
                    <li class="relative dropdown lg:mt-0">
                        <button href="#"
                            ...
                            id="pages" data-bs-toggle="dropdown">Pages <i
                                class="align-middle bx bxs-chevron-down ltr:ml-1 rtl:mr-1"></i></button>
                        <div
                            class="relative top-auto z-50 py-2 list-none bg-white border-0 rounded dropdown-menu lg:border border-gray-500/20 lg:absolute lg:w-[40rem] lg:shadow-lg dark:bg-neutral-800 hidden">
                    ...
                    <li class="relative dropdown lg:mt-0">
                        ...
                        <ul class="relative top-auto z-50 py-2 list-none bg-white border-0 rounded dropdown-menu lg:border border-gray-500/20 lg:absolute ltr:-left-3 rtl:-right-3 lg:w-48 lg:shadow-lg dark:bg-neutral-800 hidden"
                            ...
                            @foreach (getAllCategories() as $category)
                                <li><a class="block w-full px-4 py-2 text-13 font-medium text-gray-700 duration-300 bg-transparent dropdown-item whitespace-nowrap hover:translate-x-1.5 group-data-[theme-color=violet]:hover:text-violet-500 group-data-[theme-color=sky]:hover:text-sky-500 group-data-[theme-color=red]:hover:text-red-500 group-data-[theme-color=green]:hover:text-green-500 group-data-[theme-color=pink]:hover:text-pink-500 group-data-[theme-color=blue]:hover:text-blue-500 uppercase group-data-[mode=dark]:text-gray-50"
                                        href="{{ route('client.category-detail', $category->id) }}">{{ $category->category_name }}</a>
                                </li>
                            @endforeach
