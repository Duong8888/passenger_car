...
@section('content')
{{-- < lang="en" dir="ltr" data-mode="light" class="scroll-smooths group" data-theme-color="violet"> --}}
    
<!-- Mirrored from themesdesign.in/jobcy-tailwind/layout/candidate-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Sep 2023 13:45:20 GMT -->
<head>
        <meta charset="utf-8" />
                        ...
                        <div class="grid">
                            <div class="col-span-12">
                                <div class="text-center text-white">
                                    <h3 class="mb-4 text-[26px]">Chi tiết vé xe</h3>
                                    <div class="page-next">
...
<!-- Mirrored from themesdesign.in/jobcy-tailwind/layout/candidate-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Sep 2023 13:45:21 GMT -->
@endsection