                                    ...
                                    <nav class="inline-block" aria-label="breadcrumb text-center">
                                        <ol class="flex flex-wrap justify-center text-sm font-medium uppercase">
                                            ...
                                            <li class="active" aria-current="page"><i
                                                    class="bx bxs-chevron-right align-middle px-2.5"></i>Blog Details</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="grid grid-cols-12 md:gap-8">
                        <div class="col-span-12 md:col-span-6 md:col-start-4">
                            <div class="text-center">
                                ...
                                <h3 class="text-gray-900 text-[26px] dark:text-white">How to get creative in your work ?
                                </h3>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="flex align-top">
                                        ...
                                        <div class="ltr:ml-3 rtl:mr-3 flex-grow-1">
                                            ...
                                            <div class="flex mt-8 align-top">
                                                <div class="shrink-0">
                                                    <img class="p-1 rounded-full h-14 w-14 ring-2 ring-gray-100/20"
                                                        src="{{ asset('client') }}/images/user/img-04.jpg" alt="img">
                                                </div>
                                                <div class="ltr:ml-3 rtl:mr-3 flex-grow-1">
                                                    <small
                                                        class="text-xs text-gray-500 ltr:float-right rtl:float-left dark:text-gray-300"><i
