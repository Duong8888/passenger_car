                    ...
                    <div class="grid">
                        <div class="col-span-12">
                            <div class="text-center text-white">
                                <h3 class="mb-4 text-[26px]">{{ $post->title }}</h3>
                                <div class="page-next">
                                    <nav class="inline-block" aria-label="breadcrumb text-center">
                                        <ol class="flex flex-wrap justify-center text-sm font-medium uppercase">
                                            ...
                                            <li class="active" aria-current="page"><i
                                                    class="bx bxs-chevron-right align-middle px-2.5"></i>{{ $post->title }}
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                    ...
                    <div class="grid grid-cols-12 md:gap-8">
                        <div class="col-span-12 md:col-span-6 md:col-start-4">
                            <div class="text-center">
                                <p class="mb-0 font-semibold text-red-600">{{ $post->category->category_name }}</p>
                                <h3 class="text-gray-900 text-[26px] dark:text-white">{{ $post->title }}
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div class="grid grid-cols-12 mt-8 md:gap-14">
                        <div class="col-span-12 lg:col-span-8">
                            <div class="swiper blogdetailSlider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ asset('client') }}/images/blog/img-11.jpg" alt=""
                                            class="rounded-lg">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ asset('client') }}/images/blog/img-14.jpg" alt=""
                                            class="rounded-lg">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ asset('client') }}/images/blog/img-15.jpg" alt=""
                                            class="rounded-lg">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <p class="text-gray-500 dark:text-gray-300">Objectively pursue diverse catalysts for change
                                    for interoperable meta-services. Distinctively re-engineer revolutionary meta-services
                                    and premium architectures. Intrinsically incubate intuitive opportunities and real-time
                                    potentialities. Appropriately communicate one-to-one technology.</p>
                                <p class="mb-4 text-gray-500 dark:text-gray-300">Home renovations, especially those
                                    ...
                                    stressful situations of all kinds, including the most common of all making mistakes.</p>
                                <figure class="text-center blog-blockquote">
                                    <blockquote class="blockquote">
                                        <p class="text-17 dark:text-gray-50">"A business consulting agency is involved in
                                            the planning, implementation, and education of businesses."</p>
                                    </blockquote>
                                ...
                                <p class="text-gray-500 dark:text-gray-300">Whether article spirits new her covered hastily
                                    sitting her. Money witty books nor son add. Chicken age had evening believe but proceed
                                    pretend mrs. At missed advice my it no sister. Miss told ham dull knew see she spot near
                                    can. Spirit her entire her called.</p>
                                <p class="text-gray-500 dark:text-gray-300">The advantage of its Latin origin and the
                                ...
                                <div class="flex items-center my-4">
                                    ...
                                    <div class="ltr:ml-2 rtl:mr-2 flex-grow-1">
                                        <a href="javascript:void(0)"
                                            class="px-1.5 py-0.5 mt-1 text-sm font-medium text-green-500 bg-green-500/20 rounded">Business</a>
                                        <a href="javascript:void(0)"
                                            class="px-1.5 py-0.5 mt-1 text-sm font-medium text-green-500 bg-green-500/20 rounded">design</a>
                                        <a href="javascript:void(0)"
                                            class="px-1.5 py-0.5 mt-1 text-sm font-medium text-green-500 bg-green-500/20 rounded">Creative</a>
                                        <a href="javascript:void(0)"
                                            class="px-1.5 py-0.5 mt-1 text-sm font-medium text-green-500 bg-green-500/20 rounded">Event</a>
                                    </div>
                                </div>
                                ...
                                <h5
                                    class="pb-3 mt-8 text-gray-900 border-b border-gray-100/50 dark:text-gray-50 dark:border-zinc-700">
                                    Comments</h5>
                                <div class="mt-8">
                                    <div class="flex align-top">
                                        <div class="shrink-0">
                                            <img class="p-1 rounded-full w-14 h-14 ring-2 ring-gray-100/20"
                                                src="{{ asset('client') }}/images/user/img-01.jpg" alt="img">
                                        </div>
                                        <div class="ltr:ml-3 rtl:mr-3 grow">
                                            <small
                                                class="text-xs text-gray-500 ltr:float-right rtl:float-left dark:text-gray-300"><i
                                                    class="uil uil-clock"></i> 30 min Ago</small>
                                            <a href="javascript:(0)"
                                                class="text-gray-900 transition-all duration-500 ease-in-out hover:bg-violet-500 dark:text-gray-50">
                                            ...
                                            <p class="mb-0 italic text-gray-500 dark:text-gray-300">" There are many
                                ...
                                <div class="mt-8">
                                    <div class="flex align-top">
                                        <div class="shrink-0">
                                            <img class="p-1 rounded-full h-14 w-14 ring-2 ring-gray-100/20"
                                                src="{{ asset('client') }}/images/user/img-02.jpg" alt="img">
                                        </div>
                                        <div class="ltr:ml-3 rtl:mr-3 flex-grow-1">
                                            ...
                                            <p class="mb-0 text-gray-500 fst-italic dark:text-gray-300">" The most
                                                important aspect of beauty was, therefore, an inherent part of an object,
                                                rather than something applied superficially, and was based on universal,
                                                recognisable truths. "</p>
                                            ...
                                            <div class="flex mt-8 align-top">
                                                ...
                                                <div class="ltr:ml-3 rtl:mr-3 flex-grow-1">
                                                    ...
                                                    <p class="mb-0 text-sm text-gray-500 dark:text-gray-300">Aug 10, 2021
                                                    </p>
                                                    <div class="my-3">
                                                        <a href="javascript: void(0);"
                                                            class="bg-gray-50 px-1.5 py-1 text-xs rounded group-data-[theme-color=violet]:text-violet-500 group-data-[theme-color=sky]:text-sky-500 group-data-[theme-color=red]:bg-red-500 group-data-[theme-color=green]:text-green-500 group-data-[theme-color=pink]:text-pink-500 group-data-[theme-color=blue]:text-blue-500 font-medium dark:bg-violet-500/20"><i
                                                    ...
                                                    <p class="mb-0 text-gray-500 fst-italic dark:text-gray-300">" This
                                                        response is important for our ability to learn from mistakes, but it
                                                        alsogives rise to self-criticism, because it is part of the
                                                        threat-protection system. "</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <form action="#" class="mt-8 contact-form">
                                        <h5
                                            class="pb-3 text-gray-900 border-b border-gray-100/50 dark:text-gray-50 dark:border-zinc-700">
                                            Leave a Message</h5>
                                        <div class="grid grid-cols-12 gap-5 mt-6">
                                            <div class="col-span-6">
                                                <div class="relative mb-3">
                                                    <label for="name"
                                                        class="text-gray-900 dark:text-gray-50">Name</label>
                                            ...
                                            <div class="col-span-6">
                                                <div class="relative mb-3">
                                                    <label for="email" class="text-gray-900 dark:text-gray-50">Email
                                                        address</label>
                                            ...
                                            <div class="col-span-12">
                                                <div class="relative mb-3">
                                                    <label for="subject"
                                                        class="text-gray-900 dark:text-gray-50">Subject</label>
                                            ...
                                            <div class="col-span-12">
                                                <div class="relative mb-3">
                                                    <label for="comments"
                                                        class="text-gray-900 dark:text-gray-50">Meassage</label>
                                    ...
                                    <div class="pb-8 swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="relative overflow-hidden rounded-md group/blogpost">
                                                <img src="{{ asset('client') }}/images/blog/img-04.jpg" alt=""
                                                ...
                                                <div class="absolute bottom-3 ltr:left-3 rtl:right-3">
                                                    ...
                                                    <p class="mt-1 text-gray-200"> <a href="blog-author.html"
                                                            class="font-bold text-white-50">Rebecca Swartz</a> - 5 mins ago
                                                    </p>
                                                </div>
                                            </div>
                                        </div><!--end blogSlider-->
                                        <div class="swiper-slide">
                                            <div class="relative overflow-hidden rounded-md group/blogpost">
                                                <img src="{{ asset('client') }}/images/blog/img-05.jpg" alt=""
                                                    class="w-full h-[400px] object-cover duration-500 ease scale-110 rounded-md group-hover/blogpost:-translate-x-4 group-hover/blogpost:transition-all">
                                                <div class="absolute inset-0 bg-gradient-to-t from-black/50"></div>
                                                <div class="absolute bottom-3 ltr:left-3 rtl:right-3">
                                                    <a href="blog-details.html" class="text-white">
                        ...
                        <div class="col-span-12 lg:col-span-4">
                            <form class="relative">
                                ...
                                <button class="absolute rounded top-3 ltr:right-4 rtl:left-4" type="submit"><span
                                        class="text-gray-500 mdi mdi-magnify"></span></button>
                            </form>
                            ...
                            <div class="mt-8">
                                ...
                                <ul class="my-4">
                                    <li
                                        class="flex flex-wrap items-center pb-4 mb-4 border-b gap-y-3 md:gap-y-0 border-gray-100/50 dark:border-zinc-600">
                                        <img src="{{ asset('client') }}/images/blog/img-01.jpg" alt=""
                                            class="w-[86px] object-cover h-16 rounded">
                                        <div class="ltr:ml-3 rtl:mr-3 grow">
                                            <a href="blog-details.html"
                                                class="overflow-hidden font-medium text-gray-900 truncate dark:text-gray-50">The
                                                evolution of landing page creativity</a>
                                            <span class="block text-sm text-gray-500 dark:text-gray-300">Aug 10,
                                                2021</span>
                                        </div>
                                    </li>
                                    <li
                                        ...
                                        <div class="ltr:ml-3 rtl:mr-3 grow"><a href="blog-details.html"
                                                class="overflow-hidden font-medium text-gray-900 truncate dark:text-gray-50">Beautiful
                                                day with friends in paris</a>
                                            <span class="block text-sm text-gray-500 dark:text-gray-300">Jun 24,
                                                2021</span>
                                        </div>
                                    </li>
                                    <li
                                        ...
                                        <img src="{{ asset('client') }}/images/blog/img-03.jpg" alt=""
                                            class="w-[86px] object-cover h-16 rounded">
                                        <div class="ltr:ml-3 rtl:mr-3 grow"><a href="blog-details.html"
                                                class="overflow-hidden font-medium text-gray-900 truncate dark:text-gray-50">Project
                                                discussion with team</a>
                                            <span class="block text-sm text-gray-500 dark:text-gray-300">July 13,
                                                2021</span>
                                        </div>
                                    </li>
                                    <li class="flex flex-wrap items-center pb-4 mb-4 gap-y-3 md:gap-y-0">
                                        <img src="{{ asset('client') }}/images/blog/img-10.jpg" alt=""
                                            class="w-[86px] object-cover h-16 rounded">
                                        <div class="ltr:ml-3 rtl:mr-3 grow"><a href="blog-details.html"
                                                class="overflow-hidden font-medium text-gray-900 truncate dark:text-gray-50">Smartest
                                                Applications for Business</a>
                                            <span class="block text-sm text-gray-500 dark:text-gray-300">Feb 01,
                                                2021</span>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="mt-8">
                                ...
                                <ul class="mt-3 mb-0 text-gray-900 dark:text-gray-50">
                                    <li class="py-1"><a class="mr-2 text-gray-500 dark:text-gray-300"
                                            href="javascript:void(0)"><i class="uil uil-angle-right-b"></i> March 2021</a>
                                        (40)</li>
                                    <li class="py-1"><a class="mr-2 text-gray-500 dark:text-gray-300"
                                            href="javascript:void(0)"><i class="uil uil-angle-right-b"></i> April 2021</a>
                                        (08)</li>
                                    <li class="py-1"><a class="mr-2 text-gray-500 dark:text-gray-300"
                                            href="javascript:void(0)"><i class="uil uil-angle-right-b"></i> Nov 2020</a>
                                        (32)</li>
                                    <li class="py-1"><a class="mr-2 text-gray-500 dark:text-gray-300"
                                            href="javascript:void(0)"><i class="uil uil-angle-right-b"></i> May 2020</a>
                                        (11)</li>
                                    <li class="py-1"><a class="mr-2 text-gray-500 dark:text-gray-300"
                                            href="javascript:void(0)"><i class="uil uil-angle-right-b"></i> Jun 2019</a>
                                        (21)</li>
                                </ul>
                            </div>
                            <div class="mt-8">
