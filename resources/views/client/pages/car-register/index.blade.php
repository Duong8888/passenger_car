                            ...
                            <form method="post" class="mt-4 contact-form" name="myForm" id="myForm">
                                ...
                                <div class="grid grid-cols-12 gap-4">
                                    ...
                                    <div class="col-span-12 lg:col-span-6 px-2">
                                        ...
                                        <input type="text" name="phone" id="phone" class="w-full mt-1 rounded border border-gray-200 placeholder:text-sm placeholder:text-gray-400 dark:bg-transparent dark:border-none focus:ring-0 focus:ring-offset-0 dark:text-gray-200" placeholder="Số điện thoại liên hệ">
                                    </div>
                                    <div class="col-span-12 lg:col-span-6 px-2">
                                        <label for="email" class="text-gray-900 dark:text-gray-50">Email</label>
                                        <input type="email" class="w-full mt-1 rounded border border-gray-200 placeholder:text-sm placeholder:text-gray-400 dark:bg-transparent dark:border-none focus:ring-0 focus:ring-offset-0 dark:text-gray-200" id="email" name="email" placeholder="Nhập email của bạn">
                                    </div>
                                    <div class="col-span-12 lg:col-span-6 px-2">
                                        <label for="passengerCar_name" class="text-gray-900 dark:text-gray-50">Tên hãng xe</label>
                                        <input type="text" class="w-full mt-1 rounded border border-gray-200 placeholder:text-sm placeholder:text-gray-400 dark:bg-transparent dark:border-none focus:ring-0 focus:ring-offset-0 dark:text-gray-200" id="passengerCar_name" name="passengerCar_name" placeholder="Nhập tên hãng xe">
                                    </div>
                                    <div class="col-span-12 px-2">
                                        ...
                                        <input type="text" name="province" id="province" class="w-full mt-1 rounded border border-gray-200 placeholder:text-sm placeholder:text-gray-400 dark:bg-transparent dark:border-none focus:ring-0 focus:ring-offset-0 dark:text-gray-200" placeholder="Nhập Tỉnh/ Thành phố">
                                    </div>
                                    <div class="col-span-12 px-2">
                                        <label for="messageInput" class="text-gray-900 dark:text-gray-50">Nội dung tư vấn</label>
                                        <textarea class="w-full mt-1 rounded border border-gray-200 placeholder:text-sm placeholder:text-gray-400 dark:bg-transparent dark:border-none focus:ring-0 focus:ring-offset-0 dark:text-gray-200" id="messageInput" placeholder="Nhập nội dung bạn muốn tư vấn" name="messageInput" rows="3"></textarea>
                                    </div>
                                </div>
