                                ...
                                <div class="grid grid-cols-6 gap-4">
                                    ...
                                    <div class="col-span-6 lg:col-span-6 px-2">
                                        <div class="mb-3">
                                            ...
                                            <input required type="number" name="phone" id="phone" class="w-full mt-1 rounded border-gray-100/50 placeholder:text-sm placeholder:text-gray-400 dark:bg-transparent dark:border-gray-800 focus:ring-0 focus:ring-offset-0 dark:text-gray-200" placeholder="Số điện thoại liên hệ">
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-span-12 lg:col-span-6 px-2">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-span-6 px-2">
                                        <div class="mb-3">
                                            <label for="number_card" class="text-gray-900 dark:text-gray-50">Số chứng minh nhân dân <span style="color: red;">*</span> </label>
                                            <input required type="number" name="number_card" id="" class="w-full mt-1 rounded border-gray-100/50 placeholder:text-sm placeholder:text-gray-400 dark:bg-transparent dark:border-gray-800 focus:ring-0 focus:ring-offset-0 dark:text-gray-200" placeholder="Số chứng minh nhân dân ">
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-span-6 px-2">
                                        <div class="mb-3">
                                            <label for="rental_code" class="text-gray-900 dark:text-gray-50">Mã số thuế<span style="color: red;">*</span> </label>
                                            <input required type="number" name="rental_code" id="" class="w-full mt-1 rounded border-gray-100/50 placeholder:text-sm placeholder:text-gray-400 dark:bg-transparent dark:border-gray-800 focus:ring-0 focus:ring-offset-0 dark:text-gray-200" placeholder="Mã số thuế">
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-span-6 px-2">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-span-12">
                                        <div class="mb-3">
                                            <label for="province" class="text-gray-900 dark:text-gray-50">Tải ảnh lên <span style="color: red;">*</span> </label>
                                            <input  class="w-full mt-1 rounded border-gray-100/50 placeholder:text-sm placeholder:text-gray-400 dark:bg-transparent dark:border-gray-800 focus:ring-0 focus:ring-offset-0 dark:text-gray-200" type="file" name="images[]" id="images" multiple accept="image/*">
                                        </div>
