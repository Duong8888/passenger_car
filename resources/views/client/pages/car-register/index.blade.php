                    ...
                    <div class="mt-4">
                        ...
                        <form
                            ...
                            <div class="grid grid-cols-12">
                                <div class="col-span-12 lg:col-span-5 px-2">
                                    <div class="mb-3">
                                        <label for="fullName" class="text-gray-900 dark:text-gray-50">Họ và tên <span style="color: red;">*</span> </label>
                                        <input type="text" name="fullName" id="fullName" class="w-full mt-1 rounded border-gray-100/50 placeholder:text-sm placeholder:text-gray-400 dark:bg-transparent dark:border-gray-800 focus:ring-0 focus:ring-offset-0 dark:text-gray-200" placeholder="Họ và tên">
                                    </div>
                                </div><!--end col-->
                                <div class="col-span-12  lg:col-span-5 px-2">
                                    <div class="mb-3">
