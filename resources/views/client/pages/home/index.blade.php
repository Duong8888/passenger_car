        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-1 gap-5">
                <div class="text-center">
                    ...
                    <p class="mb-5 text-gray-500 whitespace-pre-line dark:text-gray-300">Một số nhà xe có lượt đặt vé
            ...
            <div class="grid grid-cols-12 gap-5">
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4">
                    <div
                        ...
                        <div class="p-5">
                            ...
                            <p class="mb-3 text-gray-500 dark:text-gray-300">Due to its widespread use as filler text
                                for layouts, non-readability is of great importance: human perception.</p>
                            <a href="blog-details.html"
                               class="font-medium group-data-[theme-color=violet]:text-violet-500 group-data-[theme-color=sky]:text-sky-500 group-data-[theme-color=red]:text-red-500 group-data-[theme-color=green]:text-green-500 group-data-[theme-color=pink]:text-pink-500 group-data-[theme-color=blue]:text-blue-500">Read
                                more <i class="align-middle mdi mdi-chevron-right"></i></a>
                        </div>
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4">
                    <div
                        ...
                        <div class="p-5">
                            <a href="blog-details.html" class="primary-link">
                                <h5 class="mb-1 text-gray-900 fs-17 dark:text-gray-50">Design your apps in your own way
                                    ?</h5>
                            </a>
                            <p class="mb-3 text-gray-500 dark:text-gray-300">One disadvantage of Lorum Ipsum is that in
