                                        ...
                                        <div class="col-span-12 lg:col-span-3">
                                            <div class="mb-2 mb-md-0">
                                                ...
                                                <h5 class="mb-1 fs-18"><a href="job-details.html"
                                                        class="text-gray-900 dark:text-gray-50">{{ $car->user->name
                                                        }}</a>
                                        ...
                                        <div class="col-span-12 lg:col-span-3">
                                            ...
                                            <div class="mb-2 lg:flex">
                                                ...
                                                <p class="mb-0 text-gray-500 dark:text-gray-300"><span
                                                        ...
                                                        --
                                                        {{
                                                        \Carbon\Carbon::parse($workingTime->arrival_time)->format('H:i')
                                                        }}</span>
                                                </p>
                                            </div>
                                                ...
                                                <div class="mb-2 lg:flex" style="margin-left: -35px">
                                                    ...
                                                    <p class="mb-0 text-gray-500 dark:text-gray-300"
                                                        style="font-weight: bold;"><span style="font-weight: bold;">{{
                                                            $car->route->departure }}</span>
                                                        --> {{ $car->route->arrival }}</p>
                                                </div>
                                                <p style=" font-weight: bold;"
                                                    class="mb-2 text-gray-500 dark:text-gray-300"><span
                                                        style="color: #1890ff;">{{ number_format($car->price, 0, ',',
                                                        ',') }}đ</span>
                                                </p>
                ...
                <div class="col-span-12 lg:col-span-6">
                    <div class="tab-content">
                        <div class="block tab-pane" id="v-pills-home-tab">
                            <img src="{{ asset('') }}client/images/process-01.png" alt="" class="max-w-full">
                        </div>
                        <div class="hidden tab-pane" id="v-pills-profile">
                            <img src="{{ asset('') }}client/images/process-02.png" alt="" class="max-w-full">
                        </div>
                        <div class="hidden tab-pane" id="v-pills-messages">
                            <img src="{{ asset('') }}client/images/process-03.png" alt="" class="max-w-full">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="mt-4">
                    <div
                        ...
                        <div class="mt-4 text-center">
                            ...
                            {{-- <p class="mt-1 font-medium text-gray-500 dark:text-gray-300">{{date('d-m-Y',
                    ...
                    <div class="relative overflow-hidden">
                        ...
                        <div
                            ...
                            <p class="mb-0 "><i class="mdi mdi-account text-light"></i> <a href="javascript:void(0)"
                                    class="text-light user">{{ $post->user->name }}</a>
                            </p>
