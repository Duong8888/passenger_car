                                                    ...
                                                    <div class="col-span-12 lg:col-span-3">
                                                        ...
                                                        <div class="mb-2 lg:flex">
                                                            ...
                                                            <p class="mb-0 text-gray-500 dark:text-gray-300"><span
                                                                    style="font-weight: bold;"> {{ \Carbon\Carbon::parse($workingTime->departure_time)->format('H:i') }} -- {{ \Carbon\Carbon::parse($workingTime->arrival_time)->format('H:i') }}</span>
                                                            </p>
                                                        </div>
                    ...
                    <div class="col-span-12 md:col-span-6 lg:col-span-4">
                        <div
                            ...
                            <div class="relative overflow-hidden">
                                <img style="min-width: 100%;height: 300px;" src="{{ asset($post->image) }}" alt="tin tuc" class="rounded">
                                <div
                                ...
                                <div
                                    ...
                                    <p class="mb-0 "><i class="mdi mdi-account text-light"></i> <a href="javascript:void(0)"
                                                                                                class="text-light user">{{ $post->user->name }}</a></p>
                                    <p class="mb-0 text-light date"><i class="mdi mdi-calendar-check"></i> {{ $post->created_at->format('d/m/Y') }}</p>
                                </div>
                                <div
                            ...
                            <div class="p-5">
                                <a href="blog-details.html" class="primary-link">
                                    <h5 class="mb-1 text-gray-900 fs-17 dark:text-gray-50">{{ $post->title }}</h5>
                                </a>
                                <div class="mb-3 text-gray-500 dark:text-gray-300"> {!! Str::limit($post->content,600) !!}</div>
                                <a href="blog-details.html" style="font-size: 27px;color: #007aff !important;"
                                class="font-medium group-data-[theme-color=violet]:text-violet-500 group-data-[theme-color=sky]:text-sky-500 group-data-[theme-color=red]:text-red-500 group-data-[theme-color=green]:text-green-500 group-data-[theme-color=pink]:text-pink-500 group-data-[theme-color=blue]:text-blue-500">Xem thêm <i class="fa-solid fa-angles-right" style="color: #007aff"></i></a>
                            </div>
                        </div>
                    </div>
                @endforeach
