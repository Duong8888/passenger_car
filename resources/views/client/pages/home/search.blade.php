        ...
        <div class="grid items-center grid-cols-12 rtl:gap-10">
            <div class="col-span-12 col-start-2">
                <div class="mb-3 text-center ltr:mr-14 rtl:ml-14">
                    <h1 class="mb-3 text-5xl leading-tight text-white fw-semibold">Deposit money to donate to me<br> At
                        least <span class="text-yellow-500 fw-bold">5+ </span> eggs.</h1>
