                            ...
                            <div class="border rounded border-gray-100/50 dark:border-neutral-600">
                                <div class="p-5 border-b border-gray-100/50 dark:border-neutral-600">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h6 class="mt-4 mb-0 text-lg text-gray-900 dark:text-gray-50">{{ $user->name }}
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <div class="p-5">
                                    ...
                                    <h6 class="mb-3 font-semibold text-gray-900 text-17 dark:text-gray-50">Thông tin người
                                        đặt</h6>
                                    <ul>
                                        <li>
                        ...
                        <div class="col-span-12 lg:col-span-8">
                            <div class="p-6 border rounded border-gray-100/50 info:border-neutral-600">
                                ...
                                <div class="col-span-12 lg:col-span-1 mb-5" style="margin: -20px 0 0 250px">
                                    ...
                                    <img src="{{ asset($tickets->passengerCar->albums[0]->path) }}" alt="tickets"
                                        class="img-fluid rounded-3" style="width:50%">
                                </div>
                                <div class="grid grid-cols-12" style="padding: 0 30px 0 30px">
                                    <div class="col-span-12 lg:col-span-6">
                                        <div class="mt-2 lg:mt-0">
                                            <label class="text-sm text-gray-500 dark:text-gray-50">
                                                <h6>Tên nhà xe: <span>{{ $tickets->passengerCar->user->name }}</h6></span>
                                            </label> <br>
                                            <label class="text-sm text-gray-500 dark:text-gray-50">
                                                <h6>Điểm đi: <span>{{ $tickets->departure }}</h6></span>
                                            </label> <br>
                                            <label class="text-sm text-gray-500 dark:text-gray-50">
                                                <h6>Số lượng ghế: <span>{{ $tickets->quantity }}</h6></span>
                                            </label> <br>
                                            <label class="text-sm text-gray-500 dark:text-gray-50">
                                                <h6>Trạng thái : <span>{{ $tickets->payment_method }}</h6></span>
                                            </label> <br>
                                        </div>
                                    </div>
                                    <div class="items-center col-span-12 lg:col-span-6">
                                        <div class="mt-2 lg:mt-0">
                                            <label class="text-sm text-gray-500 dark:text-gray-50">
                                                <h6>Số điện thoại: <span>{{ $tickets->passengerCar->user->phone }}</h6>
                                                </span>
                                            </label> <br>
                                            <label class="text-sm text-gray-500 dark:text-gray-50">
                                                <h6>Điểm đến: <span>{{ $tickets->arrival }}</h6></span>
                                            </label> <br>
                                            <label class="text-sm text-gray-500 dark:text-gray-50">
                                                <h6>Tổng tiền:
                                                    <span>{{ number_format($tickets->total_price, 0, ',', ',') }}đ</h6>
                                                </span>
                                            </label> <br>
                                            <label class="text-sm text-gray-500 dark:text-gray-50">
                                                <h6>Tổng tiền: <span>{{ $tickets->created_at }}</h6></span>
                                            </label> <br>
                                        </div>
