                                    ...
                                    <nav class="inline-block" aria-label="breadcrumb text-center">
                                        <ol class="flex flex-wrap justify-center text-sm font-medium uppercase">
                                            ...
                                            <li><i class="bx bxs-chevron-right align-middle px-2.5"></i><a
                                                    href="javascript:void(0)">Chi tiết xe</a></li>
                                            <li class="active" aria-current="page"><i
                                                    class="bx bxs-chevron-right align-middle px-2.5"></i>Thanh toán
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                            ...
                            <div class="border rounded-md border-gray-100/30 dark:border-neutral-600/80">
                                <div class="p-6">
                                    <div class="mt-5">
                                        ...
                                        <div>
                                            <p class="mb-2 text-gray-500 dark:text-gray-300">- Bạn hãy có mặt tại điểm đón trước 15 phút và kiểm tra hành lý trước khi lên chuyến xe.</p>
                                            <p class="mb-2 text-gray-500 dark:text-gray-300">- Báo với nhân viên nhà xe bạn đã thanh toán trên website của chúng tôi và chụp ảnh đã thanh toán trên website.</p>
                                            <p class="mb-2 text-gray-500 dark:text-gray-300">- Nếu tới thời gian khởi hành mà bạn không đến thì hãy hủy vé hoặc báo kịp thời cho chúng tôi nếu không thì sẽ không được hoàn tiền.</p>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="p-6">
                                                        <ul class="space-y-4">
                                                            <li class="px-4 py-2 bg-white rounded dark:bg-neutral-600">
                                                                <p  class="text-gray-900 dark:text-white">Nghệ An</p>
                                                            </li>
                                                            <li class="px-4 py-2 bg-white rounded dark:bg-neutral-600">
                                            ...
                                            <div class="col-span-12 md:col-span-12 xl:col-span-12">
                                                <div class=" rounded bg-gray-50 dark:bg-neutral-700">
                                                    <div class="p-6">
                                                        <ul class="space-y-4">
                                                            <li class="px-4 py-2 bg-white rounded dark:bg-neutral-600">
                                                                <p  class="text-gray-900 dark:text-white"> Hà Nội</p>
                                                            </li>
                                                            <li class="px-4 py-2 bg-white rounded dark:bg-neutral-600">
                                                                <p  class="text-gray-900 dark:text-white">15:38 2/11/2023</p>
                                                            </li>
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div>
                                            <p
                                            class="btn w-full bg-yellow-500/20 border-transparent text-yellow-500 hover:-translate-y-1.5 dark:bg-yellow-500/30"><i class="fa-solid fa-exclamation fa-beat"  style="font-size: 20px"></i>   Lúc hủy chuyển khi đã thanh toán sẽ không được hoàn tuyền online vì chúng tôi không có thời gian để xử lý, Vì vậy hãy tới trược tiếp để biết thêm chi tiết và hoàn tiền nếu muôn !</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="p-6">
                                    <div>
                                        ...
                                        <div class="mt-4 text-center">
                                            <h6 class="text-gray-900 text-17 dark:text-gray-50">Phan'z Nam'z
                                            </h6>
                                            ...
                                            <li>
                                                <div class="flex">
                                                    ...
                                                    <div class="ltr:ml-3 rtl:mr-3">
                                                        <h6 class="mb-1 text-sm text-gray-900 dark:text-gray-50">Số điện thoại
                                                        </h6>
                                                        <p class="text-sm text-gray-500 dark:text-gray-300">0111111111111</p>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="mt-3">
                                                <div class="flex">
                                                    ...
                                                    <div class="ltr:ml-3 rtl:mr-3">
                                                        <h6 class="mb-1 text-sm text-gray-900 dark:text-gray-50">Email
                                                        </h6>
                                                        <p class="text-sm text-gray-500 dark:text-gray-300">
                                                            namclient@gmail.com</p>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                                        ...
                                        <li>
                                            <div class="flex mt-6">
                                                ...
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    <h6 class="mb-2 text-sm text-gray-900 dark:text-gray-50">Phương thức thanh toán
                                                    </h6>
                                                    <p class="text-gray-500 dark:text-gray-300">Nhà xe</p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <div class="flex mt-6">
                                                ...
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    ...
                                                    <p class="text-gray-500 dark:text-gray-300">Dương zzzz</p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="flex mt-6">
                                                ...
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    ...
                                                    <p class="text-gray-500 dark:text-gray-300">ghế ngồi 111 chỗ</p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="flex mt-6">
                                                ...
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    <h6 class="mb-2 text-sm text-gray-900 dark:text-gray-50">
                                                       Số lượng khách</h6>
                                                    <p class="text-gray-500 dark:text-gray-300">2</p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="flex mt-6">
                                                ...
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    ...
                                                    <p class="text-gray-500 dark:text-gray-300">200.000đ</p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="flex mt-6" style="border-top: 1px solid #333333;padding-top: 15px">
                                                <style>.{border-top: 1px solid #333333;padding-top: 5px !important}</style>
                                                <i
                                                    class="uil uil-history icon group-data-[theme-color=violet]:bg-violet-500/20 group-data-[theme-color=sky]:bg-sky-500/20 group-data-[theme-color=red]:bg-red-500/20 group-data-[theme-color=green]:bg-green-500/20 group-data-[theme-color=pink]:bg-pink-500/20 group-data-[theme-color=blue]:bg-blue-500/20 h-12 w-12 text-center leading-[2.4] text-xl group-data-[theme-color=violet]:text-violet-500 group-data-[theme-color=sky]:text-sky-500 group-data-[theme-color=red]:text-red-500 group-data-[theme-color=green]:text-green-500 group-data-[theme-color=pink]:text-pink-500 group-data-[theme-color=blue]:text-blue-500 rounded-full"></i>
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    <h6 class="mb-2 text-sm text-gray-900 dark:text-gray-50">Tổng tiền
                                                    </h6>
                                                    <p class="text-gray-500 dark:text-gray-300">200.000đ</p>
                                                </div>
                                            </div>
