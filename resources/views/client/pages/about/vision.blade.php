                                    ...
                                    <div class="page-next">
                                        <nav class="inline-block" aria-label="breadcrumb text-center">
                                            <ol class="flex flex-wrap justify-center text-sm font-medium uppercase">
                                                ...
                                                <li><i class="bx bxs-chevron-right align-middle px-2.5"></i><a href="javascript:void(0)">Về chúng tôi</a></li>
                                                <li class="active" aria-current="page"><i class="bx bxs-chevron-right align-middle px-2.5"></i> Tầm nhìn </li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="container mx-auto">
                            <div class="grid items-center grid-cols-12 gap-5">
                                <div class="col-span-12 lg:col-span-6">
                                    ...
                                    <h2 class="mt-1 mb-4 text-gray-900 dark:text-gray-50/80">Tầm nhìn</h2>
                                    <p>Tầm nhìn của Car Finder Pro là trở thành một nền tảng hàng đầu trong lĩnh vực đặt xe khách nhanh chóng và tiện lợi. Chúng tôi muốn mang lại trải nghiệm tốt nhất cho người dùng và giúp họ dễ dàng tìm kiếm, so sánh và đặt vé xe khách một cách thuận tiện.</p><br>
                                    <p>
                                        Car Finder Pro hoạt động với mục tiêu cung cấp cho người dùng một lựa chọn đa dạng về dịch vụ xe khách từ các nhà cung cấp uy tín. Chúng tôi xây dựng một mạng lưới rộng lớn các đối tác đáng tin cậy, đảm bảo rằng người dùng có thể tìm thấy các tùy chọn phù hợp với nhu cầu và ưu tiên của họ.
                                    </p> <br>
                                    <p>
                                        Chúng tôi cam kết đảm bảo chất lượng dịch vụ thông qua việc thu thập đánh giá và nhận xét từ người dùng. Điều này giúp tạo ra một cộng đồng đáng tin cậy và giúp người dùng có quyết định thông minh khi lựa chọn dịch vụ xe khách.
                                    </p> <br>
                                    <p>
                                        Tóm lại, tầm nhìn của Car Finder Pro là trở thành một nền tảng hàng đầu trong việc đặt xe khách nhanh chóng và tiện lợi, mang lại trải nghiệm tốt nhất cho người dùng và đáp ứng đa dạng nhu cầu về dịch vụ xe khách. Chúng tôi cam kết mang đến sự thuận tiện, tin cậy và thông tin chi tiết cho người dùng, giúp họ có trải nghiệm tuyệt vời khi sử dụng dịch vụ của chúng tôi.
                                    </p>
